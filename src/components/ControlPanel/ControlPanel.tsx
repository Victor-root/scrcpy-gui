...
const PerformanceGrid = ({ config, onChange, rendererOptions, showResolution = true }: { config: ScrcpyConfig, onChange: (field: keyof ScrcpyConfig, value: any) => void, rendererOptions: { value: any, label: string }[], showResolution?: boolean }) => {
    const { t } = useI18n();
    return (
        <>
