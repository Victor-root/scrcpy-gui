...
export const ru: Translations = {
  ...
  sessionBehavior: {
    ...
    clipboardAutosync: 'Автосинхронизация буфера обмена',
    clipboardAutosyncTooltip: 'Автоматически копировать буфер обмена устройства в буфер обмена компьютера при каждом изменении. Отключите, если фоновые изменения буфера обмена на устройстве (подсказки клавиатуры, приложения и т.д.) постоянно перезаписывают то, что вы только что скопировали на компьютере. Ручное копирование-вставка (Ctrl+C / Ctrl+V) всё равно продолжает работать.',
    disableMouseHover: 'Отключить эффекты наведения мыши',
    disableMouseHoverTooltip: 'Не даёт курсору мыши вызывать эффекты наведения Android (например, кнопка тускнеет просто от наведения курсора) при движении без клика, как при настоящем касании. Клики по-прежнему работают как обычно.',
